...
class VariantCloner
{
    ...
    public static function clone(int $post_id)
    {
        ...
        // Tried again in August 2026 and reverted — core's page lists do hide
        // a drafted variant now, but Elementor's do not go through them, and
        // that is what broke the first time.
