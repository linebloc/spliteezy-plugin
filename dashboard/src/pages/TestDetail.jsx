  ...
  return (
    <div className="eezy-wrap">
      ...
      <div className="eezy-info-cards">
        <InfoCard label={__('Started', 'spliteezy')} value={formatDate(test.started_at)} sub={days > 0 ? sprintf(/* translators: %d: number of days. */ __('%d days running', 'spliteezy'), days) : __('Started today', 'spliteezy')} />
        <InfoCard label={__('Ends', 'spliteezy')}    value={endLabel(test.end_mode, test.end_value, test.confidence_threshold)} />
        ...
        {totalVisitors > 0 && (
          <InfoCard label={__('Total visitors', 'spliteezy')} value={totalVisitors.toLocaleString()} sub={sprintf(/* translators: %s: number of conversions. */ __('%s conversions', 'spliteezy'), totalConversions.toLocaleString())} />
        )}
      </div>
      ...
      <div className="eezy-card eezy-card--flush">
        ...
        <div style={{ borderTop: '1px solid #f3f4f6' }}>
          ...
          <div className="eezy-perf-header">
            ...
            <SortHeader label={__('Confidence', 'spliteezy')}  field="confidence"  sortKey={sortKey} sortDir={sortDir} onSort={handleSort} />
            <span />
          </div>
